    ...
    <div class="kriterys">
        ...
        <?php
            if (isset($_SESSION['error'])) {
                ?><p class="session__error"><?php echo $_SESSION['error']; unset($_SESSION['error']) ?></p> <?php
            }
            foreach ($criterion as $value) { ?>
                ...
                <div class="block__kriterys">
                    ...
                    <div class="ocenka-kritery">
                        ...
                        ?>
                        <form method="post" id="form__gap" action="/competition/<?php echo $competition['id'] ?>/grade" name="gradeCriterion" class="deleteParticipants">
                            <?php
