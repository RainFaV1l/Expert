...
<div class="conkurs-admin">
    ...
    <div class="categorys__conkurs-admin">
        ...
        <a href="/competition/<?php echo $competition['id'] ?>/participants" class="cat__conkurs-admin active">Участники</a>
        <a href="/competition/<?php echo $competition['id'] ?>/experts" class="cat__conkurs-admin">Эксперты</a>
                ...
                if(!empty($participant['patronymic'])) {?>
                    <div class="user">
                        ...
                        <div class="btns__user">
                            <form method="post" action="/competition/<?php echo $competition['id'] ?>/deletePartisipant" name="deleteParticipants" class="deleteParticipants">
...
<!--                            <a href="/competition/--><?php //echo $participant['id'] ?><!--/deletePartisipant" class="delete-user">Удалить</a>-->
        ...
        <a href="/competition/<?php echo $competition['id'] ?>/participants_add" class="btn-add-kritery">
            Добавить участника
        </a>
    </div>
</div>
